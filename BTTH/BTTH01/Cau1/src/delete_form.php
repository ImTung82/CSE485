<?php
    ...
    // Lấy thông tin hoa cần xóa
    $flowerToDelete = $_SESSION['flowers'][$index];
?>
    ...
    <div class="w-full h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-lg w-[400px]">
            ...
            <form action="delete_process.php" method="post" class="mt-4">
                ...
                <a href="admin_view.php" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500">Không</a>
            </form>
        </div>
    </div>
</body>
